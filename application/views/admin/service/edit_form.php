			...
			<div class="container-fluid">
				...
				<div class="card mb-3">
					...
					<div class="card-body">
						...
						<form action="<?php base_url('admin/service/edit') ?>" method="post" enctype="multipart/form-data">

							<input type="hidden" name="id" value="<?php echo $service->id_jasa?>" />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('harga_jasa') ? 'is-invalid':'' ?>"
								 type="number" name="harga_jasa" min="0" placeholder="Harga Jasa" value="<?php echo $service->harga_jasa ?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('keterangan') ? 'is-invalid':'' ?>"
								 name="keterangan" placeholder="Keterangan"><?php echo $service->keterangan ?></textarea>
								<div class="invalid-feedback">
